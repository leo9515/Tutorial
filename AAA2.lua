...
["Here you can allow other scripts"] = "這裏妳可以使用其他腳本",
...
["the settings, which you can modify here."] = "壹些妳其他的在這裏修改的設置",
...
["To change controls just click here   \\/"] = "點這裏來改變控制設置",
["Evading        | Hold"] = "按住躲避",
...
["Blitzcrank | Q - Rocket Grab"] = "布裏茨 | Q - 機械飛爪",
...
["To change the hotkey go to \"Controls\"."] = "在\"控制\"裏修改熱鍵",
["Disable"] = "關閉",
["Arrow"] = "箭頭",
...
["PRIORITY"] = "優先級",
["Set your priority here:"] = "在這裏設定優先級",
...
["|> Smart lasthit will use spellsettings from the lasthitmenu"] = "|> 智能尾刀會使用尾刀菜單裏的技能設置",
...
["Draw enemy FoW minions line"] = "顯示戰爭迷霧裏的兵線",
...
["On FoW teleport/recall log client-sided chat notification"] = "聊天框提醒戰爭迷霧裏的傳送/回城",
...
["Version:"] = "版本:",
["Combat keys are located in orbwalking settings"] = "戰鬥按鍵在走砍裏設置",
-----------------------時間機器艾克--------------
...
["Reveal enemy in bush"] = "對草叢裏的敵人自動插眼",
...
["Malphite"] = "墨菲特",
["Keybindings are in the Orbwalking Settings menu"] = "按鍵設置在走砍設置菜單裏",
...
["Cast Ult on FoW enemies"] = "對戰爭迷霧裏的敵人使用R",
