...
function AAAUpdate:draw()
	...
	if self.updating then
		DrawTextA("[AAA] 升級中", 25, 10,h*0.05,ARGB(255,255,255,255), "left", "center")
	end
	if updated then
		DrawTextA("[AAA] 升級完成, 請按 2xF9", 25, 10,h*0.05,ARGB(255,255,255,255), "left", "center")
	end
end
...
["Reset Settings"] = "重置設置",
["Nidalee and Teemo Traps"] = "(Baw)女和提莫的陷阱",
...
["Override - Anchor Settings"] = "取代定位設置",
["Override - Humanizer"] = "取代擬人化",
...
["Allow enabling/disabling evading"] = "可以啟用/禁用躲避",
["Allow enabling/disabling Bot Mode"] = "可以啟用/禁用機器人模式",
["WARNING:"] = "警告",
...
["Allow changing path while evading"] = "可以在躲避時改變路線",
...
["Note:"] = "注意",
["While activated, this mode overrides some of"] = "當你激活這個選項時可能會取代",
...
["Combat/Chase Mode | Hold 1"] = "戰鬥/追擊模式 | 按鍵1",
["Combat/Chase Mode | Hold 2"] = "戰鬥/追擊模式 | 按鍵2",
["Combat/Chase Mode | Toggle"] = "戰鬥/追擊模式 | 開關",
["Panic Mode     | Refresh"] = "應急模式     | 刷新",
["Panic Mode Duration (seconds)"] = "應急模式持續時間（秒）",
...
["Show \"Doubleclick to remove!\""] = "顯示雙擊移除(Doubleclick to remove!)",
...
["Allow casting while evading"] = "躲避的時候可以使用技能",
...
["Mouse Position"] = "鼠標位置",
["Hero Position"] = "英雄位置",
["Allow Casting"] = "可以技能使用",
["Block Casting"] = "屏蔽技能使用",
["Modify/Block [Any direction]"] = "修正/屏蔽 [任何方向]",
["Modify/Block [Only towards cast position]"] = "修正/屏蔽 [順著技能的方向]",
["Modify/Allow [Any direction]"] = "修正/可以 [任何方向]",
["Modify/Allow [Only towards cast position]"] = "修正/可以 [順著技能的方向]",
["Minimum Range"] = "最小範圍",
["Maximum Range"] = "最大範圍",
...
["Movement Enabled"] = "可以移動",
["Attacks Enabled"] = "可以攻擊",
...
["------ DRAWS ------"] = "------ 顯示 ------",
["This allow you draw your target on"] = "這項設置可以將目標顯示在屏幕上",
...
["to only trigger them if enemy/object"] = "屏幕上時所有選項才生效",
["is on your Screen"] = " ",
...
["Q Color"] = "Q技能線圈顏色",
["Combo"] = "連招",
["Orbwalk Settings (Vital)"] = "走砍設置(弱點)",
["Vital-hit Angle Pull Direction Method"] = "弱點命中角度定位方式",
["Closest Angle"] = "最近的角度",
["X/Y Axis"] = "X/Y軸",
["Vital Angle in degrees"] = "弱點角度",
["LaneClear Lunge (Q)"] = "在清線中使用Q",
["LaneClear Bladework (E)"] = "在清線中使用E",
["LaneClear Grand Challenge (R)"] = "在清線中使用R",
["Min Minions to use R"] = "使用R的最少小兵數",
["Jungle Lunge (Q)"] = "在清野中使用Q",
["Jungle Bladework (E)"] = "在清野中使用E",
["Jungle Grand Challenge (R)"] = "在清野中使用R",
["Draw Grand Challenge Duration"] = "顯示無雙挑戰持續時間",
["--- Combo Logic ---"] = "--- 連招邏輯 ---",
...
["Parry is still a Work In Progress"] = "格擋選項是仍在開發的選項",
...
["Allow Mid-Jump Transform"] = "可以跳躍的空中變換形態",
["Harass (Human form)"] = "騷擾(人形態)",
["Use Javelin Toss (Q)"] = "使用人形態Q騷擾",
["Use Toggle Key Override (Keybinder Menu)"] = "使用按鍵開關取代",
...
["Use Takedown (Q)"] = "使用(Baw)形態Q",
["Use Pounce (W)"] = "使用(Baw)形態W",
["Use Swipe (E)"] = "使用(Baw)形態E",
...
[">| under enemy turrets. If ally minions >= X then it allows diving!"] = ">| 如果友方小兵數大於等於x就會可以越塔",
...
[">| If both >= X then it allows diving!"] = "如果都大於等於x就會可以越塔",
...
["Allow casts only for targets in camera"] = "只在目標在屏幕上時可以使用技能",
...
["Blue Trinket"] = "藍色飾品",
["Green Trinket"] = "綠色飾品",
["[Kalista] - Draw Settings "] = "[卡莉斯塔] - 顯示設置",
["Draw (Q) Range"] = "畫出Q範圍",
["Draw (E) Range"] = "畫出E範圍",
["Draw (R) Range"] = "畫出R範圍",
...
["Override Minimum Hit % "] = "取代最小命中率",
["Overriden Minumum Hit %"] = "被取代的最小命中率",
...
["Autoping SS (bol broken)"] = "丟失視野自動標記(bol選項損壞)",
...
["(bol broken) Ping when big monsters respawns"] = "大型野怪復活時標記(bol選項損壞)",
["Only me"] = "只是自己",
["My team"] = "己方隊伍",
...
["(bol broken) Ally ping SS"] = "(bol選項損壞)友軍標記敵軍消失",
...
["Broken Wings [Utility]"] = "Broken Wings [選項設置]",
["Utility [Killsteal]"] = "選項設置 [搶人頭]",
["Use [R2 - Windslash]"] = "使用 [R2 - 疾風斬]",
["Utility [Defensive]"] = "選項設置 [防禦]",
["Auto W"] = "自動W",
...
["Enable Long Range R (prediction)"] = "可以使用遠距離R（預判位置）",
...
["High Noon"] = "西部牛仔 - 燼",
["ON: Always"] = "開: 總是",
["ON: Only on marked"] = "開: 只對有標記的目標",
["Use E-W Combo"] = "使用E-W連招",
["Use R auto kill"] = "使用R自動擊殺",
["KS With Q"] = "使用Q搶人頭",
["W Method: "] = "W 方式:",
["Less Often"] = "使用頻率更低",
["W on traps when not in combat"] = "不在戰鬥中時對踩陷阱的敵人使用W",
["Prefire W on traps"] = "提前對即將踩陷阱的敵人使用W",
["W under min if reloading"] = "在裝彈時即使低於最小距離也使用W",
["ON"] = "開",
["Auto R max initiation range"] = "自動R的最大起始範圍",
["Use Farsight Orb on FoW enemies"] = "對戰爭迷霧中的敵人使用遠見改造",
["Use Youmuu's before starting Ult"] = "開大之前使用幽夢",
["Use Ult on: "] = "對以下目標使用R",
["Only best target"] = "只對最佳目標使用",
["All targets"] = "對所有目標使用",
["----Jungle Clear Settings----"] = "----清野設置----",
["----Wave Clear Settings----"] = "----清線設置----",
["----Last Hit Settings----"] = "----尾刀設置----",
["Use Q while reloading"] = "裝彈時使用Q",
["Use W while reloading"] = "裝彈時使用W",
["Use W while out of range"] = "目標在範圍外時使用W",
["ON: Last Hit and Harass Modes"] = "開: 尾刀和騷擾模式",
["Auto-Buy Blue Trinket"] = "自動購買藍色飾品",
["Show recall notifications"] = "顯示回城提示",
["On and client side ping"] = "開啟並且在本地標記",
["FHPrediction"] = "FH預判",
["Draw Reload Timer"] = "顯示裝彈時間",
["Draw (R) Killable Text"] = "顯示R可擊殺文字",
----------------MMA-----------------
...
["Allowed Condemn Targets"] = "可以眩暈的目標",
...
["*Don't use this if you are not sure*"] = "*如果你不明白的話不要使用這個選項*",
...
["Nasus"] = "內瑟斯",
["Use Q for faster Base leave"] = "使用Q以快速離開基地",
["Orbwalk to Catch Q position"] = "移動以調整Q位置",
["Magnet distance to catch Q return"] = "調整Q返回彈道的吸附性距離",
["Use W on combo"] = "在連招中使用W",
["Only use E if Q is ready"] = "只在Q就緒的時候使用E",
["Use E on Nasus"] = "對內瑟斯使用E",
["Ignore ^ if enemy is under X% HP"] = "忽略生命值低於X%的敵人",
["Use R in combat"] = "在連招中使用R",
["Cast R when Overkill %"] = "當傷害溢出X%時使用R",
["^(-X = cast early, +X = cast late)"] = "^ (-X = 提早使用, +X = 延後使用)",
["Use R to hit enemy with Q return"] = "使用R調整Q範圍的位置以擊中敵人",
[" ##  R safety check  ## "] = " ##  R技能安全檢查  ## ",
["Consider enemies around:"] = "檢查周圍的敵人",
["Enemy detection range ^"] = "檢查敵人數量的範圍",
["Enemies on range for be careful ^"] = "敵人數量高於X時需要注意安全",
["Cast R Above % HP"] = "生命值高於%時使用R",
["Extra delay between R"] = "三段R之間的額外延遲",
["Extra E Options"] = "E技能額外設置",
["Use E to interrupt enemy spells"] = "使用E來打斷敵人技能",
["Use E vs enemy gapclose"] = "使用E來打斷突進者",
["Safe Zone Settings"] = "安全區域設置",
["Enable usage of safe zone"] = "啟用安全區域",
["--- Safe Zone Distance ---"] = "--- 安全區域距離 ---",
["Distance that trigger it"] = "觸發安全區域的距離",
["--- Safe Zone Draw ---"] = "--- 安全區域顯示 ---",
["Draw Safe Zone"] = "顯示安全區域",
["Safe Zone color"] = "安全區域顏色",
["--- Use E Safe Zone on ---"] = "--- 安全區域內E技能使用 ---",
["Auto Q charmed enemies"] = "自動對被魅惑的敵人使用Q",
["Cast it on Nasus"] = "對內瑟斯釋放",
["Flee Settings"] = "逃跑設置",
["Use Q on flee mode"] = "在逃跑模式下使用Q",
["Use E on flee mode"] = "在逃跑模式下使用E",
["Use R on flee mode"] = "在逃跑模式下使用R",
["Use Fox-Fire (W)"] = "使用妖異狐火(W)",
["Use E only if Q ready"] = "只在Q就緒的時候使用E",
["Min mana to cast W"] = "使用W的最小藍量",
["Draw Q Orbwalk Magnet range"] = "顯示Q修正移動的吸附性範圍",
["Draw Ball"] = "顯示寶珠",
["Draw Q Catch circle"] = "顯示Q修正移動地點",
["Draw Ult duration"] = "顯示大招持續時間",
["Draw Estimated Damage"] = "顯示估算的傷害",
["Cast Ignite on Nasus"] = "對內瑟斯使用點燃",
["-- E Settings --"] = "--- E技能設置 ---",
...
["[CougarW] Spell Settings"] = "W[(Baw)形態]技能設置",
["[CougarWHunt] Spell Settings"] = "W帶被動[(Baw)形態]技能設置",
["[CougarE] Spell Settings"] = "E[(Baw)形態]技能設置",
...
["Hitchance of Cougar (W)"] = "W[(Baw)形態]命中率",
["Hitchance of Cougar (E)"] = "E[E形態]命中率",
[">> General settings:"] = ">> 常規設置",
[">> General spells"] = ">> 常用技能",
["(R) - Switch forms"] = "R變形",
[">> Choose your (Cougar) spells"] = ">> 選擇你的[(Baw)形態]技能",
["(W) - Use Pounce"] = "使用W - 猛撲",
[">> Baseswitch to (Cougar)"] = ">> 在基地裡變形為[(Baw)形態]",
...
["> Team <"] = "> 友軍 <",
[">> Form settings:"] = ">> 形態設置",
["Switch cougar to human if needed"] = "如果需要的話由(Baw)形態變為人形態",
["Switch from human back to cougar"] = "由人形態變為(Baw)形態",
["Only switch back if enough health %"] = "僅當生命值高於%時由人形態變為(Baw)形態",
...
["Draw cougar (Q) damage:"] = "顯示Q[(Baw)形態]傷害",
["Draw cougar (W) damage:"] = "顯示W[(Baw)形態]傷害",
["Draw cougar (E) damage:"] = "顯示E[(Baw)形態]傷害",
...
["(W) cougar color"] = "W[(Baw)形態]顏色",
["(E) cougar color"] = "E[(Baw)形態]顏色",
["> Offensive Items"] = "> 進攻型物品",
...
["[Lulu]: Orbwalking"] = "[璐璐]: 走砍設置",
["[Lulu]: Combo Settings"] = "[璐璐]: 連招設置",
["Extend Q Range With E On Ally/Minions"] = "對友軍英雄/小兵釋放E以延長Q範圍",
["Use Glitterlance (Q)"] = "使用閃耀長槍 (Q)",
["Use Whimsy (W)"] = "使用奇思妙想 (W)",
["Use Help, Pix! (E)"] = "使用幫忙,皮克斯 (E)",
["[Lulu]: Ultimate Settings"] = "[璐璐]: 大招設置",
["Knokc-UP"] = "擊飛",
["Min. Enemy To Knoock UP"] = "擊飛的最小敵人數",
["Use Auto K-U On: Nunu"] = "對努努使用擊飛",
["Auto Save"] = "自動救援",
["Min. HP %"] = "最小生命值%",
["Try Save : Lulu"] = "嘗試救援璐璐",
["[Lulu]: Prediction Settings"] = "[璐璐]: 預判設置",
["[Lulu]: Spell Q"] = "[璐璐]: Q技能設置",
["KPrediction"] = "K預判",
["[Lulu]: Harras Settings"] = "[璐璐]: 騷擾設置",
["[Lulu]: Items Settings"] = "[璐璐]: 物品設置",
["[Lulu]: Support Settings"] = "[璐璐]: 輔助設置",
["---- Mikael's Crucible ----"] = "---- 米凱爾的坩堝 ----",
["Min. Hero HP% To Use"] = "友軍最小生命值%時使用",
["---- Frost Queen's Claim ----"] = "---- 冰霜女皇的指令 ----",
["Min. Enemy HP% To Use"] = "敵軍最小生命值%時使用",
["---- Locket of the Iron Solari ----"] = "---- 鋼鐵烈陽之匣 ----",
["Use Locket of the Iron Solari"] = "使用鋼鐵烈陽之匣",
["---- Twin Shadows ----"] = "---- 雙生暗影 ----",
["---- Exhaust ----"] = "---- 虛弱 ----",
["Use Exhaust"] = "使用虛弱",
["---- Heal ----"] = "---- 治療 ----",
["Use Heal"] = "使用治療",
["[Lulu]: KS Settings"] = "[璐璐]: 搶人頭設置",
["[Lulu]: Farm Settings"] = "[璐璐]: 發育設置",
["[Lulu]: Jungle Farm Settings"] = "[璐璐]: 清野設置",
["[Lulu]: Extra Settings"] = "[璐璐]: 額外設置",
["Stop Nunu AbsoluteZero"] = "阻止努努釋放絕對零度",
["Anti GapCloser"] = "反突進",
["[Lulu]: Shield Settings"] = "[璐璐]: 護盾設置",
["Enemy Skills:"] = "敵人技能:",
["Block Nunu Spell E"] = "抵擋努努E",
["Block Nunu Spell R"] = "抵擋努努R",
["Use Shield On:"] = "使用護盾的目標:",
["Lulu"] = "璐璐",
["[Lulu]: Escape Settings"] = "[璐璐]: 逃跑設置",
["[Lulu]: Draw Settings"] = "[璐璐]: 顯示設置",
["Draw DMG Text"] = "顯示傷害",
["Draw W&E Range"] = "顯示W和E的範圍",
["Draw W&E Range Color"] = "W和E的線圈顏色",
["[Lulu]: Misc Settings"] = "[璐璐]: 雜項設置",
----------------Project Bundle-------------------
...
---------------------xAwareness--------------------
["[xAwareness]"] = "[XAwareness] 意識",
["> HUD"] = "> HUD",
["Show HUD"] = "顯示HUD",
["> Horizontal Settings"] = "> 水平設置",
["Left - Right position"] = "X軸位置",
["Up - Down position"] = "Y軸位置",
["> Vertical Settings"] = "> 垂直位置",
["> HP Bar"] = "> 血條",
["> HUD Settings"] = "> HUD設置",
["Bar type"] = "血條樣式",
["Modern"] = "新式",
["Show ally cooldowns"] = "顯示友軍的CD",
["> Modern Settings"] = "> 新式風格設置",
["Hide text timers"] = "隱藏文字計時器",
["> Enemy Pathing"] = "> 敵人路徑",
["> Enable/Disable Settings"] = "> 啟用/禁用設置",
["Enemy Path"] = "敵人路徑",
["Estimated Time"] = "預計時間",
["> Text Settings"] = "> 文字設置",
["Text size"] = "文字大小",
...
["> General Settings"] = "> 常規設置",
["Enable Alert"] = "啟用提示",
["Sound/Notification "] = "聲音/提醒",
["Ping locally"] = "本地ping",
["Ping allies"] = "ping友軍",
["Ping locally + sound"] = "本地ping + 聲音",
["Ping allies + sound"] = "ping友軍 + 聲音",
["sound only"] = "僅聲音",
["Don't display after x minutes"] = "X分鐘之後不要顯示",
["Draw Detection Radius"] = "顯示檢測半徑",
["Detection range"] = "檢測範圍",
[">> For some users sounds wil cause lag"] = ">> 使用聲音會使某些用戶出現延遲",
["> Sound Settings"] = "> 聲音設置",
["> Alert Settings"] = "> 提示設置",
["> Arrow information"] = "> 箭頭信息",
["Enable/Disable Arrow information"] = "啟用/禁用箭頭信息",
["Use advanced calculation (accurate data)"] = "使用高級計算模式(準確數據)",
["Advanced calculations are CPU heavy."] = "高級計算模式很占CPU資源",
["No enemies found."] = "沒有找到敵人",
["> Enemy targeting"] = "> 敵人目標指示",
["This will draw a line from the enemy"] = "這個選項會在敵人和他的目標之間畫線",
["to the enemy target. This is useful"] = "這對騷擾敵人補刀和檢查敵人正在鎖定誰很有用.",
["to deny their last hitting or check"] = " ",
["Who they're focussing."] = " ",
["> Missing in action"] = "> 丟失視野計時",
["Missing in action"] = "戰鬥中丟失視野計時",
["Show timers"] = "顯示計時",
["> Jungle timers"] = "> 打野計時",
["Show Dragon timer"] = "顯示小龍計時",
["Show Baron timer"] = "顯示大龍計時",
["> Enemy wards"] = "> 敵人眼位",
["Show enemy wards"] = "顯示敵人眼位",
["> Time/Date"] = "> 時間/日期",
["Show real time and date"] = "顯示現實時間和日期",
["> Tower range indicator"] = "> 防禦塔範圍",
["Show tower range"] = "顯示防禦塔範圍",
["Circle color"] = "線圈顏色",
["Yellow"] = "黃色",
["Purple"] = "粉色",
["White"] = "白色",
...
["Patch: 6.4"] = "遊戲版本: 6.4",
["Version: 1.15"] = "腳本版本: 1.15",
-------------------Ralphlol KogMaw-----------------
["Ralphlol's Kog'Maw"] = "Ralphlol 大嘴",
["Use Q combo if  mana >"] = "如果藍量大於X使用Q連招",
["Use E combo if  mana >"] = "如果藍量大於X使用E連招",
["Use R if  mana% left will be >"] = "如果藍量大於X使用R",
["Use R if stacks are <="] = "如果被動小於等於X使用R",
["Spellblade Mode: "] = "咒刃模式:",
["R Combo Usage:"] = "R連招使用",
["Rapid"] = "快速",
["Use Q harass if  mana >"] = "如果藍量大於X使用Q騷擾",
["Use E harass if  mana >"] = "如果藍量大於X使用E騷擾",
["Use R in Harass"] = "使用R騷擾",
["E also last hit minion"] = "使用E尾刀",
["R Harass Usage:"] = "R騷擾使用:",
["KS with E"] = "使用E搶人頭",
["Only R if enemy > %"] = " 只在敵人大於X時使用R",
["Use Mana Override"] = "以下情況無視藍量限制",
["For Harass"] = "騷擾",
["For Combo"] = "連招",
["For Both"] = "騷擾和連招",
["Override mana if R stack <="] = "如果R被動小於等於X無視藍量限制",
["Special Custom"] = "特殊設置",
["E Wave Clear Settings"] = "E清兵設置",
["R Wave Clear Settings"] = "R清兵設置",
["Use R in Wave Clear"] = "使用R清兵",
["Override if kill X minions"] = "能擊殺X個小兵時使用",
["Use R if  mana is above"] = "如果藍量高於X使用R",
["Draw R Mana Display"] = "顯示R技能藍耗",
["Force Shoot Ult"] = "強制釋放R",
-------------Pewtility----------------
["Pewtility"] = "Pewtility意識",
["Enable AutoUpdate"] = "啟用自動更新",
["Ward Tracker"] = "眼位監視",
["Enable Ward Timers"] = "啟用眼位計時",
["Enable Self Ward Tracker"] = "啟用己方眼位計時",
["Self Ward Tracker Scale"] = "己方眼位計時縮放",
["Timer Type"] = "計時器樣式",
["Minutes"] = "分鐘",
["Draw Hexagon on Timers"] = "在計時器上畫六邊形",
["Minimap Marker Size"] = "小地圖標記大小",
["Minimap Marker Type"] = "小地圖標記樣式",
["Marker"] = "標記",
["Timer"] = "計時",
["Draw Ward Vision Radius"] = "顯示眼位視野半徑",
["Double Click a ward to manually remove it."] = "雙擊眼位以手動移除",
["Missing Enemies"] = "敵人消失提醒",
["Enable Missing Timers"] = "啟用消失計時",
["Sprite Size"] = "圖標大小",
["Display Recall Status"] = "顯示回城狀態",
["Recall Bar Scale"] = "回城讀條縮放",
["Display Jungle Tracker"] = "顯示打野計時",
["Jungle Tracker Bar Scale"] = "打野計時讀條縮放",
["Object Timers"] = "物體計時",
["Enable Object Timers"] = "啟用物體計時",
["Text Color"] = "文字顏色",
["Minimap Text Size"] = "小地圖文字大小",
["Minimap Text Color"] = "小地圖文字顏色",
["Modifier Key(Default: Alt)"] = "調節按鍵",
["ModKey+LeftClick a camp to start a timer."] = "調整按鍵+左鍵單擊一個野怪營地開始計時",
["Trinket Helper"] = "飾品助手",
["Buy Trinket on Game Start"] = "遊戲開始時購買飾品",
["Trinket on Game Start"] = "遊戲開始時購買飾品",
["Ward Totem"] = "監視圖騰",
["Sweeper"] = "掃瞄透鏡",
["Enable Sweeper Purchase"] = "啟用購買掃瞄透鏡",
["Buy Sweeper after x Minutes"] = "在X分鐘後購買掃瞄透鏡",
["Upgrade Trinket after Lvl 9"] = "9級後升級飾品",
["Buy Sweeper on Sightstone"] = "眼石之後購買掃瞄透鏡",
["Other Stuff"] = "其他",
["Draw Enemy Paths"] = "顯示敵人路徑",
["Path Draw Type"] = "顯示路徑方式",
["End Position"] = "終點",
["Draw Ally Turret Ranges"] = "顯示己方防禦塔範圍",
["Warding Helper (beta)"] = "插眼助手(測試)",
["Match these to ingame keybindings."] = "修改以下設置使其與遊戲中的按鍵一致",
["Item Slot 1"] = "物品欄1",
["Item Slot 2"] = "物品欄2",
["Item Slot 3"] = "物品欄3",
["Item Slot 4"] = "物品欄4",
...
["Trinket Slot"] = "飾品欄",
["QuickCast"] = "快速釋放",
["Enable Enemy Cooldown Tracker"] = "啟用敵方CD監視",
["Enable Ally Cooldown Tracker"] = "啟用友方CD監視",
["HP Bar Scale"] = "血條縮放",
["Draw Text (Timers)"] = "顯示文字(計時器)",
["Use Old"] = "使用老樣式",
--------------------FHPrediction-----------
["Collision Buffer (seconds)"] = "碰撞緩衝(秒)",
["Collision Buffer (distance)"] = "碰撞緩衝(距離)",
["Minimum Hitchance (%)"] = "最小命中率(%)",
["^ Global minimum for all spells ^"] = "^ 對所有技能的最小命中率限制",
["FH Prediction"] = "FH預判",
[">> Immobile Callbacks"] = ">> 固定回調",
[">> Dashing Callbacks"] = ">> 位移回調",
-------------------Fun House Thresh----------
["Use Auto Shield Spell"] = "使用自動護盾",
["Ignite Settings"] = "點燃設置",
["Shield Ally Thresh"] = "對友軍使用護盾",
["Cleanse Ally Thresh"] = "對友軍使用解控",
["Show Use Auto Shield Spell"] = "顯示使用自動護盾的技能",
["Show Ignite"] = "顯示點燃",
["Show Use Ignite"] = "顯示使用點燃的狀態",
["Show Ignite Mode"] = "顯示使用點燃的模式",
["Engage (Standard) vs Peel Mode"] = "普通戰鬥模式 vs 保護模式",
["Peel mode focus enemies engaging on your carry"] = "保護模式會鎖定正在攻擊你的ADC的目標",
["Cast it on Thresh"] = "對錘石釋放",
["Thresh Fun House"] = "燒傷錘石",
["Insta Lantern"] = "使用燈籠",
["Insta E Push"] = "使用E推開",
["Insta E Pull"] = "使用E拉進",
["Fake Hook"] = "假動作勾",
["Death Sentence (Q)"] = "死亡判決(Q)",
["Whitelist Combat"] = "連招白名單",
["Use Q on Garen"] = "對草叢倫使用Q",
["Whitelist Harass"] = "騷擾白名單",
["-- General --"] = "-- 常規設置 --",
["Q Range slider Combat"] = "在連招中使用Q的範圍",
["Q Range slider Harass"] = "在騷擾中使用Q的範圍",
["Q before death when hit under hp%"] = "在生命值低於%且將要死亡的時候使用Q",
["Use Q to killsteal"] = "使用Q搶人頭",
["-- Combat --"] = "-- 連招設置 --",
["Use Q2 when enemy is killable"] = "當目標可擊殺時使用二段Q",
["Q2 when Ally is around only"] = "僅當有友軍在附近的時候使用二段Q",
["Q2 ally avg. hp% - enemy hp% > "] = "當平均友軍生命值百分比大於敵軍時使用二段Q",
["Wait E 1st if E range & ready in X sec"] = "當目標在E範圍內且E技能將在X秒後就緒時優先等待E技能",
["Use Whitelist on Combo"] = "使用連招白名單",
["-- Harass --"] = "-- 騷擾設置 --",
["Use Death Sentence (Q)"] = "使用死亡判決(Q)",
["Use Death Leap (Q2)"] = "使用死亡飛躍(Q2)",
["Use Q2 Ally is around only"] = "僅當有友軍在附近的時候使用二段Q",
["Use Whitelist on Harass"] = "使用騷擾白名單",
["Dark Passage (W)"] = "魂引之燈(W)",
["Auto W Self under %hp"] = "生命值低於%時自動對自己使用W",
["Auto W Ally under %hp"] = "自動對生命值低於%的友軍使用W",
["Auto W Extra Ally-walk range"] = "自動W計算友軍額外移動範圍",
["Use W in Combat"] = "在連招中使用W",
["Use W for brush vision"] = "使用W開草叢視野",
["Use W as path-block near wall"] = "在牆邊時使用W封路",
["Use W as ally escape"] = "使用W幫助隊友逃生",
["Ally escape Min Dist"] = "幫助隊友逃生的最小距離",
["W on-the-way Ally in Q2"] = "在二段Q的空中向隊友釋放W",
["Flay (E)"] = "懾魂掃蕩(E)",
["Auto Pull enemy under own turret"] = "自動拉近在自己防禦塔下的敵人",
["Auto Push under self hp%"] = "自身血量低於%時自動推開敵人",
["Auto E KillSteal"] = "自動使用E搶人頭",
["Use E in mid-Q2-dash"] = "在二段Q的空中使用E",
["Global E Range"] = "使用E的範圍",
["E Mode in combat"] = "連招E模式",
["The Box (R)"] = "幽冥監牢(R)",
["Whitelist PeelMode"] = "保護模式白名單",
["Use R in Combat"] = "在連招中使用R",
["Use R if enemies: "] = "以下情況使用R:",
["Auto R before death hp%"] = "在生命值低於%且將要死亡的時候使用R",
["Use R to Peel for ally"] = "使用R保護自己的友軍",
["Interrupt Dashes/Channels"] = "打斷位移/引導型技能",
["Global Enabled"] = "全局啟用",
["Interrupt Dashes Global (mid-jump)"] = "在空中打斷位移技能",
["Interrupt List List"] = "打斷列表",
["--- Interrupt Mid-Cast  ---"] = "--- 技能打斷 ---",
["Flee Mode"] = "逃跑模式",
["Use Q in Flee"] = "在逃跑模式中使用Q",
["Use Q on enemy minions to flee"] = "對敵方小兵使用Q以逃跑",
["Use Q on jungle camps to flee"] = "對野怪使用Q以逃跑",
["-- W Settings --"] = "-- W技能設置 --",
["Use W in Flee"] = "在逃跑模式中使用W",
["Use W on ally when you flee"] = "當你逃跑的時候對友軍使用W",
["Use E in Flee"] = "在逃跑模式中使用E",
["Auto Push enemy in flee mode"] = "在逃跑模式中自動推開敵人",
["Draw Path Block"] = "顯示封路",
["Path block pos color"] = "封路位置顏色",
["Debug mode"] = "調試模式",
["-- Skin Settings --"] = "-- 皮膚設置 --",
["Deep Terror"] = "深淵恐懼 錘石",
["Championship"] = "冠軍典獄長 錘石",
["Blood Moon"] = "猩紅之月 錘石",
["No skills supported for Thresh"] = "沒有支持錘石的技能",
["    Draw Garen"] = "顯示草叢倫",
["Load Big Fat Walk"] = "加載Big Fat走砍",
["Load Big Fat Activator"] = "加載Big Fat活化劑",
["Enable Vanga Dashes"] = "啟用BFVanga預判",
["Heals and Other Cds"] = "治療和其他CD",
----------------------Evade Revolution-----------------
["Key settings"] = "按鍵設置",
["General Settings:"] = "常規設置",
["Evade skillshots"] = "躲避技能",
["Draw skillshots"] = "顯示技能彈道",
["Evade spells from FoW"] = "躲避戰爭迷霧中的技能",
["Evade only dangerous spells:"] = "只躲避危險技能",
["Hold"] = "按住",
["Evadable enemy skillshots"] = "可躲避的敵人技能",
["Stuff you can use to evade"] = "可用於躲避的技能",
["Danger level to use"] = "危險等級",
["Walking"] = "移動",
["Summoner: Flash"] = "召喚師技能：閃現",
["Item: Zhonyas"] = "物品：中婭沙漏",
["Champion Collision"] = "英雄碰撞體積",
["Minion Collision"] = "小兵碰撞體積",
["Yasuo Wall Collision"] = "亞索風牆碰撞",
["Draw evade status"] = "顯示躲避狀態",
["LoL version: "] = "LoL版本：",
["Auto-level bot integration"] = "自動掛機腳本結合",
["Enable debugmode"] = "啟用調試模式",
["(DECREASES PERFORMANCE)"] = "(降低性能)",
---------------Darius NBA Challenger----------------
["Darius - The NBA Challenger"] = "德萊厄斯 - NBA挑戰者",
["> Fight "] = "> 戰鬥",
["Combo "] = "連招",
["Harass "] = "騷擾",
["> Farm keys"] = "> 發育按鍵",
...
["Auto Walk (Q)"] = "自動外圈(Q)",
["> Manage your mana:"] = "> 藍量管理",
["Check your mana before using a spell"] = "使用技能前檢查藍量",
["Minimum % of mana to use (Q)"] = "使用Q技能的最小藍量",
["Minimum % of mana to use (W)"] = "使用W技能的最小藍量",
["Minimum % of mana to use (E)"] = "使用E技能的最小藍量",
["Minimum % of mana to use (R)"] = "使用R技能的最小藍量",
["> Choose your spells:"] = "> 選擇你的技能",
["(Q) - Use "] = "使用Q",
["(W) - Use "] = "使用W",
["(E) - Use "] = "使用E",
["(R) - Use "] = "使用R",
["Use Killsteal"] = "啟用搶人頭",
["> Drawings"] = "> 顯示設置",
["Stack's Color:"] = "被動顯示顏色",
["Finish Him Color:"] = "終結敵人的顏色",
["Choose the strength of the circle"] = "",
["> Draw range of spell:"] = "> 顯示技能範圍",
["(Q) - Draw "] = "顯示Q",
["(E) - Draw "] = "顯示E",
["(R) - Draw "] = "顯示R",
["> Draw color of spell:"] = "> 技能線圈顏色",
["> Healthbar damage"] = "> 血條傷害計算",
["Draw (Q)+(W)+(E)+(R) damage: "] = "顯示Q+W+E+R的傷害",
["Draw Passiv damage:"] = "顯示被動能造成的傷害",
["Draw (R) damage:"] = "顯示R技能造成的傷害",
["More Soon"] = "更多選項添加中",
["> HPrediction"] = "> H預判",
["Hitchance of (E): "] = "E的命中率",
["Creator:"] = "作者:",
-----------------FuckoffValor------------
["FuckOffValor // Key's"] = "FuckOffValor // 按鍵設置",
["Combo(SBTW)"] = "連招",
["FuckOffValor // Combo"] = "FuckOffValor // 連招",
["Use W for ATSPD"] = "用W開視野",
["Use W if enemy walks into brush"] = "敵人進草時使用W",
["Use E only in 1vs1"] = "只在1v1時使用E",
["Use E on gapclosers"] = "使用E反突進",
["Auto R after back call(only VIP)"] = "回城自動使用R(僅限VIP)",
["FuckOffValor // Summoner Spells"] = "FuckOffValor // 召喚師技能",
["Heal if Health under -> %"] = "生命值低於%時自動使用治療",
["Auto ignite"] = "自動點燃",
["FuckOffValor // Kill Steal"] = "FuckOffValor // 搶人頭",
["FuckOffValor // Miscellaneous"] = "FuckOffValor // 雜項",
["Choose Prediction"] = "選擇預判",
["Spel Hitchance // VPrediction"] = "技能命中率 // V預判",
["1=low 2=high 3=slowed 4=stunned/rooted"] = "1=低 2=高 3=減速 4=眩暈/禁錮",
["Spell Hitchance // HPrediction"] = "技能命中率 //H預判",
["1=low 2=mid 3=high"] = "1=低 2=中 3=高",
["Get target from"] = "獲取目標",
["BoL TS"] = "BoL目標選擇",
["SAC:R"] = "SAC目標選擇",
["FuckOffValor // Drawings"] = "FuckOffValor // 顯示設置",
["FuckOffValor // Orbwalker"] = "FuckOffValor // 走砍設置",

}
local tranTableB = {
["Menu"] = "菜單",
["Chase Mode"] = "追趕模式",
["Priority Order:"] = "優先級順序",
["Speed Buffs"] = "移速增益",
["Untargetable"] = "無法選定",
["Turn Around"] = "回頭",
["Ghost"] = "幽靈疾步",
...
["Spellshields"] = "法術護盾",
["Shields"] = "普通護盾",
["Drag and Drop"] = "按住並拖動這些",
["these buttons"] = "按鈕以調整順序",
["to change the order"] = "",
["Doubleclick to remove!"] = "雙擊以移除此區域！",
["Aatrox"] = "亞托克斯",
["Akali"] = "阿卡麗",
["Alistar"] = "阿利斯塔",
["Amumu"] = "阿木木",
...
["Zilean"] = "基蘭",
["Zyra"] = "婕拉",
["Download Status: Connect to Server for VersionInfo"] = "下載狀態:連接服務器以獲取版本信息",
["Burst Combo: Off"] = "爆發連招:關閉",
["Burst Combo: Ready"] = "爆發連招:就緒",
["Download Status: Downloading VersionInfo"] = "下載狀態:獲取版本信息中",
["Waiting R ready..."] = "等待R技能就緒...",
["Waiting Q ready..."] = "等待Q技能就緒...",
["Waiting W ready..."] = "等待W技能就緒...",
["Waiting E ready..."] = "等待E技能就緒...",
["Missed last hits"] = "漏刀計數",
["Trinket"] = "飾品",
["SightWard"] = "監視圖騰",
["VisionWard"] = "真視守衛",
["sec."] = "秒",
...
["Trap"] = "約德爾誘捕器",
["90 Caliber Net"] = "90口徑網繩",
["Cast"] = "釋放",
["Noxious Blast"] = "瘟毒爆炸",
["Miasma"] = "劇毒迷霧",
["Petrifying Gaze"] = "石化凝視",
["Rupture"] = "破裂",
["Phosphorus Bomb"] = "磷光炸彈",
["Missile Barrage"] = "火箭轟擊",
["Crescent Strike"] = "新月打擊",
...
["Mystic Shot"] = "秘術射擊",
["Essence Flux"] = "精華躍動",
["Trueshot Barrage"] = "精準彈幕",
["Chum The Waters"] = "巨鯊強襲",
["Resolute Smite"] = "堅定重擊",
["Righteous Gust"] = "加里歐(E)",
["Idol Of Durand"] = "杜朗石像",
["Taunt"] = "嘲諷",
["Damage"] = "傷害",
["Boulder Toss"] = "投擲頑石",
["Boomerang Throw"] = "投擲回力標",
["Return"] = "返回",
["Wallop"] = "痛毆",
["GNAR!"] = "吶啊！",
["Barrel Roll"] = "滾動酒桶",
...
["Explosive Cask"] = "爆破酒桶",
["Buckshot"] = "窮途末路",
["Collateral Damage"] = "終極爆彈",
["Onslaught of Shadows"] = "暗影衝擊",
["Hextech Micro-rockets"] = "海克斯科技微型導彈",
["Ult"] = "大招",
["CH--2 Grenade"] = "CH-2電子風暴手雷",
["Transcendent Blades"] = "至尊鋒刃",
["Howling Gale"] = "颶風呼嘯",
["Dragon Strike"] = "巨龍撞擊",
["Shock Blast"] = "電能震盪",
["Charged"] = "充能",
...
["Lay Waste"] = "荒蕪",
["Dead"] = "死亡的",
["Thundering Shuriken"] = "奧義!千鳥",
["Void Spike"] = "虛空突刺",
["Evolved"] = "進化",
["Leap"] = "躍擊",
["Caustic Spittle"] = "腐蝕唾液",
["Void Ooze"] = "虛空淤泥",
["Living Artillery"] = "活體大炮",
["Distortion"] = "魔影迷蹤",
["Ethereal Chains"] = "幻影鎖鏈",
["Chains"] = "鎖鏈",
["Mymic"] = "故技重施",
["Sonic Wave"] = "天音波",
["Zenith Blade"] = "天頂之刃",
...
["Pix"] = "皮克斯",
["Light Binding"] = "光之束縛",
["Lucent Singularity"] = "透光奇點",
["Final Spark"] = "終極閃光",
["Unstoppable Force"] = "勢不可擋",
["Call of the Void"] = "虛空召喚",
["Arcane Smash"] = "奧術重擊",
["Sapling Toss"] = "樹苗投擲",
["Syphon Of Destruction"] = "毀滅虹吸",
["Dark Binding"] = "暗之禁錮",
["Aqua Prison"] = "碧波之牢",
["Tidal Wave"] = "怒濤之嘯",
["Dredge Line"] = "疏通航道",
...
["Attack"] = "攻擊",
["Shockwave"] = "衝擊波",
["Blinding Assault"] = "炫目攻勢",
["Prey Seeker"] = "獵物搜尋",
["Bola Strike"] = "套索打擊",
["Ki Burst"] = "鎮魂怒吼",
["Blade Of The Exile"] = "放逐之鋒",
["The Equalizer"] = "恆溫灼燒",
["Harpoon"] = "電子魚叉",
["Overload"] = "超負荷",
["Arctic Assault"] = "極寒突襲",
...
["Flame Breath"] = "烈焰吐息",
["Drake"] = "魔龍",
["Dragon』s Descent"] = "魔龍降世",
["Decimating Smash"] = "蠻橫衝撞",
["Roar of the Slayer"] = "殺手怒吼",
["Boomerang Blade"] = "迴旋之刃",
["Fracture"] = "晶體破碎",
["Crescendo"] = "狂舞終樂章",
["Starcall"] = "流星墜落",
["Equinox"] = "星體結界",
...
["Rat-ta-tat-tat"] = "火力全開",
["Acid Hunter"] = "酸蝕獵手",
["Corrosive Charge"] = "諾克薩斯腐蝕電荷",
["Piercing Arrow"] = "穿刺之箭",
["Hail Of Arrows"] = "惡靈箭雨",
["Chain Of Corruption"] = "腐敗鎖鏈",
["Baleful Strike"] = "黑暗祭祀",
["Dark Matter"] = "黑暗物質",
["Event Horizon"] = "扭曲空間",
["Split"] = "分裂",
["Plasma Fission"] = "等離子裂變",
["Missile"] = "彈道",
["Void Rift"] = "虛空裂隙",
["Tectonic Disruption"] = "構造分解",
["Vault Breaker"] = "強能衝拳",
["Death Ray"] = "死亡射線",
["Augment"] = "增強",
["Arcanopulse"] = "奧能脈衝",
["Eye of Destruction"] = "毀滅之眼",
["Shocking Orb"] = "衝擊法球",
["Rite of the Arcane"] = "奧術儀式",
["Steel Tempest"] = "斬鋼閃",
["Razor Shuriken"] = "影奧義!諸刃",
["Bouncing Bomb"] = "彈跳炸彈",
["Satchel Charge"] = "定點爆破",
["Hexplosive Minefield"] = "海克斯科技爆破雷區",
["Mega Inferno Bomb"] = "科學的地獄火炮",
["Time Bomb"] = "定時炸彈",
["Rise Of The Thorns"] = "婕拉(被動)",
["Deadly Bloom"] = "致命綻放",
["Grasping Roots"] = "纏繞之根",
["Stranglethorns"] = "絞殺之籐",
["KnockUp"] = "擊飛",
...
["Fox-Fire"] = "妖異狐火",
["Mark of the Assassin"] = "奧義!緋葉",
["Crescent Slash"] = "奧義!散華",
["Shadow Dance"] = "秘奧義!幻櫻殺繚亂",
["Headbutt"] = "野蠻衝撞",
...
["Gatling Gun"] = "格林機槍",
["Decimate"] = "大殺四方",
["Crippling Strike"] = "致殘打擊",
["Apprehend"] = "無情鐵手",
["Noxian Guillotine"] = "諾克薩斯斷頭台",
["Pale Cascade"] = "蒼白之瀑",
["Lunar Rush"] = "月神衝刺",
["Neurotoxin"] = "神經毒素",
...
["Parrrley"] = "槍火談判",
["Decisive Strike"] = "致命打擊",
["Judgment"] = "審判",
["Demacian Justice"] = "德瑪西亞正義",
["Smoke Screen"] = "煙幕彈",
["Rampage"] = "暴走",
["Spirit of Dread"] = "恐懼之靈",
["CH-2 Electron Storm Grenade"] = "CH-2電子風暴手雷",
["Bladesurge"] = "利刃衝擊",
["Hiten Style"] = "飛天姿態",
["Equilibrium Strike"] = "均衡打擊",
["Zephyr"] = "和風守護",
["Golden Aegis"] = "黃金聖盾",
["Demacian Standard"] = "德邦軍旗",
["Cataclysm"] = "天崩地裂",
["Leap Strike"] = "跳斬",
["Empower"] = "蓄力一擊",
["Super Mega Death Rocket!"] = "超究極死神飛彈",
["Soulflare"] = "靈光閃耀",
["Focused Resolve"] = "堅定不移",
["Renewal"] = "煥發",
["Laywast"] = "荒蕪",
["Null Sphere"] = "虛無法球",
["Nether Blade"] = "虛空之刃",
["Force Pulse"] = "能量脈衝",
["Riftwalk"] = "虛空行走",
["Bouncing Blades"] = "彈射之刃",
["Sinister Steel"] = "不祥之刃",
["Shunpo"] = "瞬步",
["Reckoning"] = "清算",
["Righteous Fury"] = "正義之怒",
["Electrical Surge"] = "奧義!電刃",
["Taste Their Fear"] = "品嚐恐懼",
["Enlarged Claws"] = "擴張利爪",
["Spike Racks"] = "刺鞘",
["Wings"] = "翅膀",
["Bio-Arcane Barrage"] = "生化彈幕",
["Sigil of Silence"] = "惡意魔印",
["Tempest "] = "天雷破",
["Shield of Daybreak"] = "破曉之盾",
["Ring of Frost"] = "冰霜之環",
["Seismic Shard"] = "地震碎片",
["Brutal Strike"] = "野蠻打擊",
["Ground Slam"] = "大地震顫",
...
["Make It Rain"] = "槍林彈雨",
["Mace of Spades"] = "鏟擊之錘",
["Siphon of Destruction"] = "毀滅虹吸",
["Tormented Soil"] = "痛苦腐蝕",
["Siphoning Strike"] = "汲魂痛擊",
["Wither"] = "納瑟斯(W)",
["Spirit Fire"] = "靈魂烈焰",
["Consume"] = "吞噬",
["Ice Blast"] = "冰雹",
["Vicious Strikes"] = "殘暴打擊",
["Reckless Swing"] = "魯莽揮擊",
["Command: Attack"] = "指令:攻擊",
["Spear Shot"] = "長矛飛擲",
["Aegis of Zeonia"] = "聖盾打擊",
["Heartseeker Strike"] = "穿心長矛",
["Cull the Meek"] = "暴君狂擊",
["Ruthless Predator"] = "冷庫捕獵",
["Savagery"] = "殘忍無情",
["Empowered"] = "強化",
["Battle Roar"] = "戰爭咆哮",
["Electro-Harpoon"] = "電子魚叉",
["Rune Prison"] = "符文禁錮",
["Spell Flux"] = "法術湧動",
["Twin Bite"] = "龍牙突刺",
["Burnout"] = "烈火燎原",
...
["Crushing Blow"] = "粉碎打擊",
["Nimbus Strike"] = "騰雲突擊",
["Three Talon Strike"] = "三重爪擊",
["Battle Cry"] = "狂戰怒吼",
["Audacious Charge"] = "無畏衝鋒",
["Omen of War"] = "戰爭預兆",
["Omen of Pestilence"] = "瘟疫預兆",
["Omen of Famine"] = "饑荒預兆",
["Stretching Strike"] = "彈跳炸彈",
["Unstable Matter"] = "定點爆破",
["Martial Poise"] = "武術姿態",
["Pounce"] = "猛撲",
["Cougar"] = "美洲獅",
["Quickdraw"] = "快速拔槍",
...
["Broken Wings"] = "折翼之舞",
["Hop / Crunch"] = "輕跳/猛踏",
["Relentless Pursuit"] = "冷酷追擊",
["Slice And Dice"] = "橫衝直撞",
["Deceive"] = "欺詐魔術",
["Safeguard"] = "金鐘罩",
["Stand Behind Me"] = "挺身而出",
["Living Shadow"] = "影奧義!分身",
["Sweeping Blade"] = "踏前斬",
["Shifting Sands"] = "流沙移影",
["Cutthroat"] = "割喉之戰",
["Devastating Charge"] = "毀滅衝鋒",
["Highlander"] = "高原血統",
["Overdrive"] = "過載運轉",
["Dark Frenzy"] = "暗黑狂暴",
["Blood Rush"] = "血性衝刺",
...
["Move Speed"] = "移速",
["Whimsy"] = "奇思妙想",
["Lightning Rush"] = "奧義!雷鎧",
["Sadism"] = "背水一戰",
["Stance"] = "變形",
["Acceleration Gate"] = "加速之門",
["Prismatic Barrier"] = "曲光屏障",
["Bulwark"] = "堅強壁壘",
["Twilight Shroud"] = "奧義！霞陣",
...
["Help, "] = "幫忙",
["Eclipse"] = "日蝕",
["Shroud of Darkness"] = "黑暗庇護",
["Spell Shield"] = "法術護盾",
["Black Shield"] = "黑暗之盾",
["Sanguine Pool"] = "血紅之池",
["Alpha Strike"] = "阿爾法突襲",
["Playful / Trickster"] = "古靈/精怪",
["Hallucinate"] = "幻象",
["Death Mark"] = "禁奧義！瞬獄影殺陣",
["H-28G Evolution Turret"] = "H-28G進化炮台",
["Decoy"] = "真假猴王",
["Tibbers"] = "提伯斯",
["Wind Wall"] = "風之壁障",
["Jack In The Box"] = "驚嚇魔盒",
}
...
function OnLoad()
	...
	Readme:Add("歡迎使用AAA翻譯器！")
	Readme:Add("")
	Readme:Add("版本號："..version)
	Readme:Add("")
	Readme:Add("捐助支付寶：leoxp9515@hotmail.com")
	Readme:Add("")
	Readme:Add("您的支持是我更新的最大動力.")
	Readme:Add("")
