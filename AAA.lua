...
["Use QSS/Mercurial if hard CCed"] = "如果团控很多使用水银弯刀或水银饰带",
...
["Humanizer: CC/Slow Delay (ms)"] = "拟人化延迟（毫秒）",
["CC: Usual debuffs"] = "团控：减益状态",
["CC: Slow debuff"] = "团控：减速状态",
["CC: Special cases"] = "团控：特殊",
